...
# cleung,5.23.2020,Modified code to complete assignment 6
# cleung,5.25.2002, Continued to modify code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def remove_data_from_list(task, list_of_rows):
        """Removes User's Task and Priority to Dictionary Row
        ...
        for row in lstTable:
            if row["Task"].lower() == strTask.lower:
                lstTable.remove(row)
                print("Task Removed.")
        if strTask.lower is None:
            print("Task Doesn't Exist")
        return list_of_rows, 'Success'

    @staticmethod
    def write_data_to_file(file_name, list_of_rows):
        """Write User's Task and Priority to File

        :param file_name: (string) with name of file:
        :param list_of_rows: (list) contains file data:
        :return: list_of_rows: (list) contains file data:
        """
        loadFile = open("ToDoFile.txt", "w")
